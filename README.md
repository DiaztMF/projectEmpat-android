# projectEmpat-android

Native Android educational project demonstrating RecyclerView, CardView, and ViewHolder patterns, developed as part of the Mobile App Development curriculum.
...
``bash
git clone https://github.com/DiaztMF/projectEmpat-android.git
cd projectEmpat-android
``
...
$rName is a focused Android development assignment created to master foundational mobile engineering patterns. It explores RecyclerView, CardView, and ViewHolder patterns through clean Android architecture guidelines.

## Why 

Mastering native Android development requires solid understanding of core framework components, UI lifecycles, and threading boundaries. This project provides hands-on practical implementation of RecyclerView, CardView, and ViewHolder patterns without third-party abstraction overhead.
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    Log.d("projectEmpat-android", "Activity initialized successfully");
}
``
